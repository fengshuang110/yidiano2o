...
class Easemob {
	...
	*/
	...
	public function registerUser($user)
	{
		...
		return $this->requestExecute($url,'POST',$user);
	...
	*/
	 ...
	 *        	自定义参数
	 */
	function sendText($username, $content, $ext, $from_user = "admin",$target_type = "users") {
...
/**
	...
	{
		$formgettoken="https://a1.easemob.com/".$this->org_name."/".$this->app_name."/token";
		$body=array(
		...
		$key = $this->org_name."_".$this->app_name;
