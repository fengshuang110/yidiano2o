  ...
  <section class="panel">
   ...
   <form method="post"  action="/role/add" id="form" class="form-horizontal bucket-form">
 	...
 	<div class="form-group">
      ...
      <div class="col-sm-10">
         <input type="text" required  value="{{$role['role_name']}}" class="form-control" name="role_name" placeholder="角色名称">
      </div>
    </div>            
    <div class="form-group">
      <label class="col-sm-2 control-label">角色描述</label>
      <div class="col-sm-10">
         <textarea rows="6" name="desc" required class="form-control"> {{$role['role_name']}} </textarea>
      </div>
    </div>
    <div class="form-group">
